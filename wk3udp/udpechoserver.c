...
// CE4961, Dr. Rothe
//
// Build with gcc -o udpechoserver udpechoserver.c
...
int main(int argc, char** argv) 
{
	...
	// minor issue - we will never get here, so proper cleanup will not happen.
	// a fix might be to add a ctrl-c handler
